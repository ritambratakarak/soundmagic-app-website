...
export default Heading = ({ name, color }) => {
  return (
    <View style={[styles.repeatContainer, { marginBottom: 6 }]}>
      <Text style={{ fontSize: FONT.SIZE.BIG, fontFamily: FONT.FAMILY.MEDIUM, color:color }}>{name}</Text>
    </View>
  )
}
