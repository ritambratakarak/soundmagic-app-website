...
export default Category = ({ name, image }) => {
  return (
    <TouchableOpacity style={{ width: WIDTH * 0.21, height: HEIGHT * 0.10, borderRadius: 8, alignItems: "center", borderWidth: 1, borderColor: COLORS.GRAY, marginBottom: HEIGHT * 0.012, justifyContent: 'center', }}>
