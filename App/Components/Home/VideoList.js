...
(
  <Ripple rippleDuration={1000} rippleOpacity={0.30} rippleColor={"#fff"} rippleSize={"100%"} style={{ borderRadius: 15, height: Deviceheight / 6.5, width: Devicewidth / 2.5, marginRight: 10 }} onPress={props.onPress}>
