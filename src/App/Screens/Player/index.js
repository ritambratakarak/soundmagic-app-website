...
class Player extends Component {
  ...
  getData = async () => {
    ...
    Network(`get-track-play?trackID=${this.props.location.state.id}`, "get", { authtoken })
      .then(async (res) => {
        if (res.response_code === 200) {
          console.log("getdata data", res.response_data);
          this.setState({
            reasponse: res.response_data,
            playing: false,
          })
        }  else {
      ...
      <div className='app'>
          <div className='player-wrapper'>
            <div style={{position:"absolute", width:"100%", height:"100vh", top:0, left:0}}>
              <img src={this.props.location.state.image}  style={{width:"100%", height:"100vh"}}/>
            </div>
            <ReactPlayer
              ref={this.ref}
